  ...
  <div>
    ...
    <v-dialog v-model="dialogDelete" max-width="500px">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue-darken-1" fotot="text" @click="closeDelete"
            >Kembali</v-btn
          >
          <v-btn color="blue-darken-1" fotot="text" @click="confirmhapusfoto"
            >Ya</v-btn
          >
          <v-spacer></v-spacer>
        </v-card-actions>
      ...
      >
        ...
        <v-card-actions>
          <v-btn
            ...
            >Kembali</v-btn
          >
          <v-btn @click="updatefoto()" style="background: #2f432d; color: white"
            >Ubah</v-btn
          >
        </v-card-actions>
      </v-card>
